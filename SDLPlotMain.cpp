...
int main(int argc, char* argv[]) {
    ...
    auto window = SDL_CreateWindow("SDL Plot", 100, 100, windowWidth, windowHeight, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
    ...
    auto renderer = SDL_CreateRenderer(window, -1, SDL_RENDERER_ACCELERATED | SDL_RENDERER_PRESENTVSYNC | SDL_RENDERER_TARGETTEXTURE);
    ...
    DrawGridInfo drawGridInfo {0xffffffff, 10, 10, windowHeight - 10, windowWidth - 10, 5, 5, true}; 
    DrawGrid(renderer, drawGridInfo); 
